...
class UploadPage extends Component {
    ...
    handleSubmit(event) {
        ...
        let promesa1 = axios.post(`/${this.props.url}`, bolso);
        // eslint-disable-next-line no-unused-vars
        promesa1.then((res) => {
            this.props.refresh();
            ...
            <div>
                ...
                <form className='centrarTodo' onSubmit={this.handleSubmit}>
                    ...
                    <div className=''>
                        ...
                        {this.state.imgsUploaded && (
                            <div>
                                <img
                                    id='imagenPreview'
                                    src={this.state.imagenValue}
                                    alt={this.state.descriptionValue}
                                />{' '}
                            </div>
                        )}
                        ...
                        <div className='fila'>
                            <input
                                ...
                                height='40px'
                                name='description'
                                placeholder='Describa el producto aqui'
                                value={this.state.descripcionValue}
                        ...
                        <div className='fila'>
                            ...
                            <input
                                ...
                                min='0'
                                name='cantidad'
                                value={this.state.cantidadValue}
                        ...
                        <div className='fila'>
                            <button type='button' className='pequeno'>
                                <img
                                    className='imagenTamaño'
                                    src={purse}
                                    alt='flat_icon_purse'
                                    onClick={() =>
                                        this.handleChangeTamano('pequeno')
                                    }
                                />
                            ...
                            <button
                                ...
                                value='mediano'
                                onClick={() =>
                                    this.handleChangeTamano('mediano')
                                }
                                className='mediano'
                            >
                                <img
                            ...
                            <button
                                ...
                                className='grande'
                                onClick={() =>
                                    this.handleChangeTamano('grande')
                                }
                            >
                                <img
                                    className='imagenTamaño'
                        ...
                        <div className='fila'>
                            ...
                            <div>
                                <button
                                    ...
                                    id='azulClaro'
                                    onClick={() =>
                                        this.handleChangeColor('azulClaro')
                                    }
                                >
                                    azulClaro
                                </button>
                            ...
                            <div>
                                <button
                                    ...
                                    id='amarillo'
                                    onClick={() =>
                                        this.handleChangeColor('amarillo')
                                    }
                                >
                                    amarillo
                                </button>
                        ...
                        <div id='lineaRoja'></div>
                        <div className='fila'>
                            <button type='button' id='promocion'>
                                Promocion
                            </button>
                            <label className='switch'>
                                <input
                                    ...
                                    type='checkbox'
                                    name='precio'
                                    defaultChecked={this.state.promocionValue}
                                    onChange={() =>
                                        this.handleChangePromocion()
                                    }
                                />
