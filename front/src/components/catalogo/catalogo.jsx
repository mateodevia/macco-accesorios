    ...
    render() {
        return (
            <div>
                {this.props.filtro && (
                    <SideDrawer
                        handlerFiltroTamano={this.handlerFiltroTamaño}
                        handlerFiltroPrecio={this.handlerFiltroPrecio}
                        handlerFiltroColor={this.handlerFiltroColor}
                    ></SideDrawer>
                )}
                <div className='row justify-content-center'>
                    {this.state.productosAPintar.map((producto) => (
                        <PlainCard
                ...
                {this.props.autenticado && (
                    <div id='contenedorBotonAgregar'>
                        <button id='botonAgregar' onClick={this.handleClick}>
                            Agregar
                        </button>
                    </div>
                )}
