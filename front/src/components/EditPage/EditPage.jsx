...
class EditPage extends Component {
  ...
  componentDidMount() {
    ...
    promesa.then(res => {
      ...
      newState.tamanoValue = res.data.tamaño;
      newState.imgsUploaded = true;

      this.setState(newState);

    });
    promesa.catch(() => alert("No se pudo obtener los bolsos de la base de datos"));
  }
  ...
  getPromocion() {
    return this.state.promocionValue;
  }
          ...
          <div className="">
            ...
            <div className="fila">
              <button type="button" className="pequeno">
                ...
                {(this.state.tamanoValue === "pequeño") &&
            ...
            <div className="fila">
              ...
              <label className="switch">
                <input id="PROMO" type="checkbox" name="precio" defaultChecked={this.state.promocionValue} onClick={() => this.handleChangePromocion()} />
